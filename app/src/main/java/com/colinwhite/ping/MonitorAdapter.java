...
class MonitorAdapter extends CursorAdapter {
	...
	MonitorAdapter(Context context) {
	...
	public void bindView(View view, final Context context, Cursor cursor) {
		...
		if (!(boolean) values.get(MonitorEntry.IS_LOADING)) {
			...
			viewHolder.refreshButtonView.setOnClickListener(v -> {
	...
	static class ViewHolder {
		@BindView(R.id.list_item_refresh_button) ImageButton refreshButtonView;
		@BindView(R.id.progress_bar) View progressSpinner;
		@BindView(R.id.list_item_title) TextView titleView;
		@BindView(R.id.list_item_url) TextView urlView;
		@BindView(R.id.list_item_time_last_checked) TextView lastCheckedView;
		@BindView(R.id.list_item_status) ImageView statusView;
