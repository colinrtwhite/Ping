...
public final class PingContract {
	static final String PATH_MONITOR = "monitor";
	static final String CONTENT_AUTHORITY = "com.colinwhite.ping";
	...
	public static abstract class MonitorEntry implements BaseColumns {
		...
		public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_MONITOR).build();
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/" + CONTENT_AUTHORITY + "/" + PATH_MONITOR;
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/" + CONTENT_AUTHORITY + "/" + PATH_MONITOR;
